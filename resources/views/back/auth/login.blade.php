...
<head>
    ...
    <style>
        body {
            background: #2CA6A4; /* Arka plan turkuaz */
        ...
        .form-control {
            ...
            border-radius: 5px;
            color: #4A4A4A; /* Koyu gri metin */
        }
        .btn-login {
            background: #4A4A4A; /* Koyu gri buton */
            color: white;
            border: none;
            padding: 10px;
            width: 100%;
        ...
        .btn-login:hover {
            background: #333; /* Daha koyu gri buton hover */
        }
        .login-container a {
            display: block;
            margin-top: 10px;
            color: #4A4A4A; /* Koyu gri bağlantı */
            text-decoration: none;
        }
        .login-container a:hover {
            text-decoration: underline;
            color: #333; /* Daha koyu gri bağlantı hover */
        }
    </style>
</head>
<body>
